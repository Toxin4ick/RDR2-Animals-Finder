...
public:
	...
	MenuItemBase& SetColorRect(ColorRgba color) {
		m_colorRect = color;
...
const float
MenuItemTitle_lineWidth = 0.30f,
MenuItemTitle_lineHeight = 0.06f,
MenuItemTitle_textLeft = 0.08f;

const ColorRgba
MenuItemTitle_colorRect{ 0, 0, 0, 255 },
MenuItemTitle_colorText{ 100, 0, 0, 255 };
...
const float
MenuItemDefault_lineWidth = 0.30f,
MenuItemDefault_lineHeight = 0.05f,
MenuItemDefault_textLeft = 0.01f;

const ColorRgba
MenuItemDefault_colorRect{ 181, 21, 2, 135 },
MenuItemDefault_colorText{ 255, 255, 255, 255 },
MenuItemDefault_colorRectActive{ 235, 2, 2, 185 },
